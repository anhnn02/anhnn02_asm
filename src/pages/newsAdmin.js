                              ...
                              <table class="w-full whitespace-no-wrap">
                                <thead>
                                  <tr
                                    ...
                                    <th class="pl-4 py-3">Image</th>
                                    <th class="px-4 py-3">Title</th>
                                    <th class="px-4 py-3">Catalog</th>
                                ...
                                ${posts.map((post, index) => /* html */`
                                  <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm w-10 break-all">
                                    ${post.title}
                                      <div>
                                        <p class="font-semibold">Anh Ann</p>
                                      </div>
                                    </td>
